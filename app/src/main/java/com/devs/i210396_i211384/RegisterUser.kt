...
import com.devs.i210396_i211384.network.SignupRequest
        ...
        lifecycleScope.launch {
            try {
                val response = withContext(Dispatchers.IO) {
                    apiService.signup(SignupRequest(email, password, username, firstName, lastName))
                }
                ...
                if (response.isSuccessful) {
                    ...
                    Toast.makeText(this@RegisterUser, "Registration successful!", Toast.LENGTH_SHORT).show()

                    // Navigate to EditProfile to complete profile setup
                    val intent = Intent(this@RegisterUser, EditProfile::class.java)
